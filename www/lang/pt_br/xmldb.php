...
/**
 * Strings for component 'xmldb', language 'pt_br', version '2.0'.
 *
 * @package     xmldb
 * @category    string
...
$string['float2numbernote'] = 'Aviso: Embora os campos do tipo "float" sejam 100% suportados pelo XMLDB, é recomendável migrar estes campos para o tipo "número".';
