...
/**
 * Strings for component 'quiz', language 'pt_br', version '2.0'.
 *
 * @package     quiz
 * @category    string
...
$string['addaquestion'] = 'Adicionar uma pergunra';
$string['addarandomquestion'] = 'Adicionar uma questão aleatória';
...
$string['addingrandomsamatch'] = 'Acrescentar questão de Resposta Breve aleatoria';
...
$string['attemptsallowedn'] = 'Tentativa permitida: {$a}';
...
$string['createmultiple'] = 'Adicione várias questões aleatórias ao questionário';
...
$string['decimalplaces_help'] = '<p>Este campo permite selecionar o número de algarismos decimais que serão
apresentados na classificação de cada tentativa. Por exemplo, \'0\' significa que os números mostrados serão inteiros.</p><p>Esta configuração se aplica apenas à modalidade de visualização e não altera o cálculo das notas.</p>';
...
$string['notavailable'] = 'Este questionário não está disponível neste momento';
...
$string['randomsamatch'] = 'Associação aleatória com respostas breves';
...
$string['reviewoptionsheading_help'] = '<p>Estas opções controlam quais informações o usuário podem ver quando eles revisam uma tentativa de resposta do questionário ou verifica os relatórios do questionário.</p>

<p>Imediatamente após a tentativa significa dentro de dois minutos após a tentativa ser encerrada pelo usuário clicando \'Enviar tudo e terminar\'.</p>

<p>Mais tarde, enquanto o questionário ainda está aberto significa depois deste momento, e antes da data de fechamento do questionário.</p>

<p>Depois do questionário ser fechado significa após a data de fechamento do questionário ter passado. Se o questionário não tiver uma data de fechamento este evento nunca ocorrerá.</p>

<p>Usuários com a capacidade \'View hidden grades\' [moodle/grade:viewhidden]
(normalmente professores e administradores) não são afetados por esta configuração e sempre terá permissão para rever todas as informações sobre as tentativas dos estudantes.</p>';
