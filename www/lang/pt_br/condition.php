...
/**
 * Strings for component 'condition', language 'pt_br', version '2.0'.
 *
 * @package     condition
 * @category    string
...
$string['configenableavailability'] = 'Se habilitada, esta opção permite configurar condições que controlem quando é permitido o acesso a uma atividade, baseado em datas, notas ou completação de outras atividades.';
