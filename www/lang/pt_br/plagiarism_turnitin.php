...
/**
 * Strings for component 'plagiarism_turnitin', language 'pt_br', version '2.0'.
 *
...
$string['compareinstitution_help'] = 'Esta opção está disponível apenas caso tenha configurado/adquirido um nodo customizado. Isto deve estar configurado como "Não" caso não tenha certeza.';
...
$string['filedeleted'] = 'Arquivo excluído da fila';
