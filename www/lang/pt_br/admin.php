...
/**
 * Strings for component 'admin', language 'pt_br', version '2.0'.
 *
 * @package     admin
 * @category    string
...
$string['bloglevelupgrade'] = 'Atualização da visibilidade dos blogs';
...
$string['bloglevelupgradenotice'] = 'O seu site está usando uma configuração de visibilidade de blog antiga, a <a href="bloglevelupgrade.php">atualização de visibilidade de blog </a> é recomendada.';
...
$string['configallowthemechangeonurl'] = 'Se habilitado, o tema pode ser mudado acrescentando theme={themename} a qualquer URL no Moodle.';
...
$string['configdebugstringids'] = 'Esta opção foi projetada para ajudar os tradutores. Ela mostra o arquivo de idioma e o id da string ao lado de cada string (conjunto de caracteres) que é mostrada. (Alterações nesta configuração só terão efeito quando a página for recarregada).';
...
$string['configextrauserselectorfields'] = 'Selecione quais campos serão pesquisados e exibidos além do nome completo, quando selecionando usuários, por exemplo, quando atribuindo papéis ou adicionando usuários a um grupo. Por questões de segurança, recomenda-se que o campo “username” ou identificador de usuário NÃO seja selecionado.';
...
$string['configuseexternalyui'] = 'Ao invés de usar arquivos locais, usar aquivos online disponíveis nos servidores do Yahoo!. AVISO: Isto requer uma conexão com a Internet, ou o AJAX não irá funcionar em seu site.';
...
$string['extrauserselectorfields'] = 'Ao selecionar usuários, pesquisar e mostrar';
...
$string['invalidlangpack'] = 'para editar este pacote de idioma, você precisa colocá-lo na pasta de idiomas.';
...
$string['loginpasswordautocomplete_help'] = 'Deixar isto desativado permitirá que seus usuários salvem a senha nos seus navegadores. Habilitar esta configuração fará com que seu site deixe de atender às regras estritas de validação do XHTML.';
...
$string['questioncwqpfscheck'] = 'Uma ou mais questões aleatórias no questionário estão configuradas para selecionar questões de uma mistura de categorias de questões compartilhadas e não compartilhadas. Há um relatório mais detalhado <a href="{$a->reporturl}">aqui</a> e veja a página Moodle Docs <a href="{$a->docsurl}">aqui</a>.';
...
$string['unicodeupgradenotice'] = 'No Moodle 1.6 todos os idiomas foram convertidos em Unicode. Para atualizar este site você precisa converter todos os dados da sua base de dados para o Unicode (UTF-8) utilizando o nosso script de migração. <a href="utfdbmigrate.php">Clique aqui para iniciar agora</a>!';
...
$string['useraccountuptodate'] = 'Usuário já atualizado';
...
$string['uupasswordcron'] = 'Gerado no agendador de tarefas (cron)';
$string['uupasswordnew'] = 'Nova senha do usuário';
$string['uupasswordold'] = 'Senha de usuário já existente';
$string['uustandardusernames'] = 'Padronizar "usernames"';
...
$string['uuusernametemplate'] = 'Template para "username"';
