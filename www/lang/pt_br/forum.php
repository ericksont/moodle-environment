...
/**
 * Strings for component 'forum', language 'pt_br', version '2.0'.
 *
 * @package     forum
 * @category    string
...
$string['subscriptionmode_help'] = '<P>Um subscritor é um usuário que recebe cópias de todas as mensagens de um fórum via email.
Estas mensagens são enviadas via email minutos após a redação no fórum.</p>
