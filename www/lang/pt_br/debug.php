...
/**
 * Strings for component 'debug', language 'pt_br', version '2.0'.
 *
 * @package     debug
 * @category    string
...
$string['invalidparameter'] = 'Valor inválido de parâmetro detectado, a execução não pode continuar.';
$string['invalidresponse'] = 'Valor inválido de resposta detectado, a execução não pode continuar.';
