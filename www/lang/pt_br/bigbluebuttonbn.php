...
/**
 * Strings for component 'bigbluebuttonbn', language 'pt_br', version '2.0'.
 *
...
$string['mod_form_field_description_help'] = 'Uma breve descrição para a gravação que está sendo mostrada na lista de gravações. Ela pode ser alterada por sessão.';
$string['mod_form_field_duedate'] = 'Cadastro fechado';
