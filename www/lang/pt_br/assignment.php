...
/**
 * Strings for component 'assignment', language 'pt_br', version '2.0'.
 *
 * @package     assignment
 * @category    string
...
$string['addsubmission'] = 'Enviar tarefa';
...
$string['enableemailnotification_help'] = '<p>Ativando isto, os estudantes serão notificados por email sobre suas notas e feedback.</p>
...
$string['finalizeerror'] = 'Erro: este envio não foi concluído';
...
$string['helpupload'] = '<p>Este tipo de tarefa permite a cada participante enviar um ou mais arquivos em qualquer formato.</p>
<p>Estes arquivos podem ser documentos de textos, imagens, sites em arquivo zip, ou qualquer outro tipo de arquivo.</p>
<p>Este tipo de tarefa permite fazer o envio de um ou mais arquivos de resposta. Os arquivos de resposta podem ser enviados antes da tarefa para dar a cada participante um arquivo diferente para trabalhar.
</p>
<p>Os participantes também podem inserir anotações descrevendo os arquivos enviados, o estado de progresso ou qualquer outra informação de texto. </ p>
<p>O envio deste tipo de tarefa deve ser finalizado manualmente pelo participante. Você pode analisar o estado atual a qualquer momento, as tarefas ainda não finalizadas são visualizadas como rascunho. Você pode reverter qualquer tarefa sem nota volta ao projeto</p>';
