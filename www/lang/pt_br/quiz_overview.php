...
/**
 * Strings for component 'quiz_overview', language 'pt_br', version '2.0'.
 *
...
$string['attemptprogress'] = 'Tentatuva {$a->done} de {$a->todo}';
...
$string['qprogress'] = 'Pergunta {$a->done} de {$a->todo}';
