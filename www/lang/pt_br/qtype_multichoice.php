...
/**
 * Strings for component 'qtype_multichoice', language 'pt_br', version '2.0'.
 *
...
$string['addingmultichoice'] = 'Adicionando uma pergunta de múltipla escolha';
...
$string['multichoice_help'] = 'Em resposta a uma pergunta (que pode incluir uma imagem), o entrevistado escolhe respostas múltiplas. Existem dois tipos de questões de múltipla escolha - uma resposta e múltiplas respostas.';
$string['multichoicesummary'] = 'Permite a seleção de simples ou múltiplas respostas de uma lista pré definida.';
