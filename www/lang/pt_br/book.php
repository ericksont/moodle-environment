...
/**
 * Strings for component 'book', language 'pt_br', version '2.0'.
 *
 * @package     book
 * @category    string
...
$string['book:exportimscp'] = 'Exportar livro como pacote de conteúdo IMS ';
$string['book:import'] = 'Importar capítulos';
$string['book:print'] = 'Imprimir livro';
...
$string['import_help'] = 'Você pode importar um arquivo HTML ou todos os arquivos HTML num diretório. Links relativos de arquivos  são convertidos para referências absolutas de capítulos. Também são convertidos os links para Imagens, flash e Java.';
