...
/**
 * Strings for component 'mnet', language 'pt_br', version '2.0'.
 *
 * @package     mnet
 * @category    string
...
$string['error7022'] = 'A mensagem enviada para o site remoto foi criptografada corretamente, mas não assinada. Isto é muito estranho, e provavelmente se trata de um bug. Se isso ocorrer você deve registrar (fornecendo o máximo de informação possível sobre as versões da aplicação em questão, etc.)';
