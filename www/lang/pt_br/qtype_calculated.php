...
/**
 * Strings for component 'qtype_calculated', language 'pt_br', version '2.0'.
 *
...
$string['addingcalculated'] = 'Adicionar uma pergunta calculada';
...
$string['calculated_help'] = 'Perguntas calculadas permitem questões numéricas individuais a serem criadas usando curingas em chaves que são substituídos com valores individuais quando o questionário é preenchido. Por exemplo, a pergunta "Qual é a área de um retângulo de comprimento {l} e largura {w}?" teria fórmula resposta correta "{l}*{W}" (onde * denota a multiplicação).';
$string['calculatedsummary'] = 'As perguntas calculadas são como perguntas numéricas, mas com os números utilizados sorteados a partir de um conjunto quando o questionário é preenchido.';
...
$string['editingcalculated'] = 'Editando uma pergunta calculada';
